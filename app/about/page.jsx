        ...
        <div className="relative h-screen w-screen  gap-4 p-10 flex justify-center items-center flex-col mb-10 overflow-hidden">
          ...
          <div className="z-10 w-full absolute md:w-auto md:left-[10%] top-[60%] md:top-1/3 col-span-2 flex flex-col justify-center items-start md:items-start text-start px-10 pt-4 backdrop-filter backdrop-blur-sm md:backdrop-blur-none bg-gray-100 bg-opacity-50 md:bg-transparent md:pt-0">
            ...
            <p className="title text-xl mt-4 tracking-wider text-gray-900 leading-[1.7rem] mb-5 ">
              A Brief Introduction: My Expertise and Passion in
        ...
        <div className="relative w-screen mx-auto container gap-4 px-10 grid grid-cols-1 md:grid-cols-2 mb-10">
          ...
          >
            ...
            <p className="text-gray-600 text-justify title text-lg">
              Hello, I’m Muhammad Gilang Fauzi, a{" "}
              <span className="text-black font-medium">Software Engineer</span>{" "}
              with over 4 years of experience in software development. I
              specialize in  <span className="text-black font-medium">frontend</span> technologies like React.js, Next.js, and
              Vue.js, as well as  <span className="text-black font-medium">backend</span> development with Node.js and Golang. I
              also have experience working with databases such as PostgreSQL,
