...
// images
import ReactChat1 from "@/public/projects/diarium/diarium1.png";
import ReactChat2 from "@/public/projects/diarium/diarium2.png";
import ReactChat3 from "@/public/projects/diarium/diarium3.png";
			...
			<main className="overflow-hidden">
				...
				<div className="relative w-screen mx-auto container gap-4 px-10 grid grid-cols-1 md:grid-cols-2 mb-10">
					...
					<motion.div
						...
						Diarium is a super app developed by Telkom Indonesia to support human resource (HR) management needs. This application offers various features such as attendance tracking, leave requests, business travel management (SPPD), task management, activity timelines, and performance reporting. With over 14,000 users, Diarium streamlines access to HR services for Telkom employees, providing an integrated, efficient, and modern solution.
						</p>{" "}
						{/* <div className="mt-3">
				...
				<div className="mt-16 flex flex-col justify-start items-center w-full pl-10 md:pl-32">
					<div className="flex justify-start items-start flex-col my-5 self-start ">
						...
						<motion.h1
							...
							Another project I made with love
						</motion.h1>
					</div>
				</div>
